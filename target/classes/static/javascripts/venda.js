...
//		let aa = $(evento.target).val();
//		console.log(">>>>> " + typeof aa + " - " + aa);
		
		this.valorFrete = Brewer.recuperarValor($(evento.target).val());
		
//		console.log(">>>>> Frete: " + typeof this.valorFrete + " - " + this.valorFrete);
	}
...
//		console.log("Valor valorFrete: " + this.valorFrete);
//		console.log("Valor valorDesconto: " + this.valorDesconto);
