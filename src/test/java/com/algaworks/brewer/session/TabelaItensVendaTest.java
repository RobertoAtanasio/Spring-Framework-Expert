...
public class TabelaItensVendaTest {
	...
	public void deveCalcularValorTotalComUmItem() throws Exception {
		...
		tabelaItensVenda.adicionarAtualizarItem(cerveja, 1);
	...
	public void deveCalcularValorTotalComVariosItens() throws Exception {
		...
		tabelaItensVenda.adicionarAtualizarItem(c1, 1);
		tabelaItensVenda.adicionarAtualizarItem(c2, 2);
	...
	public void deveExcluirItem() throws Exception {
		...
		tabelaItensVenda.adicionarAtualizarItem(c1, 1);
		tabelaItensVenda.adicionarAtualizarItem(c2, 2);
		tabelaItensVenda.adicionarAtualizarItem(c3, 1);
